...
type PrepareUploadResponse struct {
	...
	TotalChunks uint64 `protobuf:"varint,13,opt,name=total_chunks,json=totalChunks,proto3" json:"total_chunks,omitempty"`
	...
	AlreadyStoredCount uint64 `protobuf:"varint,14,opt,name=already_stored_count,json=alreadyStoredCount,proto3" json:"already_stored_count,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *PrepareUploadResponse) GetTotalChunks() uint64 {
	if x != nil {
...
func (x *PrepareUploadResponse) GetAlreadyStoredCount() uint64 {
	if x != nil {
		return x.AlreadyStoredCount
	}
	return 0
}
...
const file_antd_v1_upload_proto_rawDesc = "" +
	...
	"visibility\x18\x02 \x01(\tR\n" +
	"visibility\x122\n" +
	"\x15include_signed_quotes\x18\x03 \x01(\bR\x13includeSignedQuotes\"\x9e\x05\n" +
	...
	"\arpc_url\x18\n" +
	" \x01(\tR\x06rpcUrl\x12>\n" +
	"\rsigned_quotes\x18\f \x03(\v2\x19.antd.v1.SignedQuoteEntryR\fsignedQuotes\x12!\n" +
	"\ftotal_chunks\x18\r \x01(\x04R\vtotalChunks\x120\n" +
	"\x14already_stored_count\x18\x0e \x01(\x04R\x12alreadyStoredCount\"\xab\x01\n" +
