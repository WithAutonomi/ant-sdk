defmodule Antd.Client do
  ...
  @spec file_upload_public(t(), String.t(), keyword()) :: {:ok, Antd.FileUploadResult.t()} | {:error, Exception.t()}
  ...
  @spec file_upload_public!(t(), String.t(), keyword()) :: Antd.FileUploadResult.t()
